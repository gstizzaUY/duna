## 5.6.95
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.108.
- **FIX:** Minor bugfixes.

## 5.6.94
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.107.
- **UPD:** Motors Listing Types updated to version 1.4.6.
- **UPD:** Motors Elementor Widgets updated to version 1.6.15.
- **UPD:** Motors WPBakery Widgets updated to version 1.7.7.
- **ENHANCEMENTS:** Enabled compatibility between Motors Pro and Motors Listing Types for inventory customization features.
- **FIX:** Fixed display of similar listings by category.
- **FIX:** Fixed registration form not showing when New User Registration is disabled in WPBakery demos.
- **FIX:** Fixed WPBakery frontend editor not saving changes for EV Dealership.

## 5.6.93
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.105.
- **UPD:** STM Extends plugin updated to version 2.6.5.
- **UPD:** WooCommerce templates updated to the latest version.
- **FIX:** Fixed incorrect display of Price Range slider in Search Filter.
- **FIX:** Fixed Sellers Notes not displaying on Built-in Listing Page templates in WPBakery demos.
- **FIX:** Fixed Privacy Policy checkbox on Message to Dealer form not clickable in Built-in Listing Page templates.
- **FIX:** Fixed duplicate Search Results in Built-in Listing Page templates.
- **FIX:** Fixed Dealer Profile Settings not saving.

## 5.6.92
- **FIX:** Minor bugfix

## 5.6.91
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.104.
- **UPD:** Motors Elementor Widgets updated to version 1.6.14.
- **UPD:** Motors WPBakery Widgets updated to version 1.7.6.
- **UPD:** Motors Listing Types updated to version 1.4.5.
- **FIX:** Fixed duplicate video in listings created via Add Your Item on frontend.

## 5.6.90
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.103.
- **FIX:** Fixed Saved Search add-on not working.
- **FIX:** Fixed display of Custom Field child categories with assigned parent categories.
- **FIX:** Fixed error on the Single Listing page on Auto Parts Demo  in Turkish language.
- **FIX:** Fixed Become dealer setting not displaying.

## 5.6.89
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.102.
- **UPD:** Motors Elementor Widgets plugin updated to version 1.6.13.
- **UPD:** Motors WPBakery Widgets plugin updated to version 1.7.5.
- **FIX:** Fixed issue allowing registration of new users with New User Registration disabled.

## 5.6.88
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.101.
- **UPD:** Motors Elementor Widgets updated to version 1.6.12.
- **FIX:** Fixed compatibility issue with Elementor 3.34.0 preventing login attempts.
- **FIX:** Fixed compatibility issue with Elementor 3.34.0 causing incorrect display of Add Car form.

## 5.6.87
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.100.
- **UPD:** Motors Elementor Widgets plugin updated to version 1.6.11.
- **UPD:** Motors WPBakery Widgets plugin updated to version 1.7.4.
- **FIX:** Added the ability to translate the Privacy Policy checkbox text via Loco Translate.

## 5.6.86
- **UPD:** Compatibility with WordPress 6.9
- **UPD:** STM Motors Extends plugin updated to version 2.6.4
- **UPD:** Motors Elementor Widgets plugin updated to version 1.6.10
- **UPD:** Motors – Car Dealer, Classifieds & Listing updated to version 1.4.98
- **FIX:** Fixed the issue where selecting built-in Listing Templates reset the selection to the default template in the Electric Vehicle Dealership demo.
- **FIX:** Fixed the issue where Number of Listings per Tab did not work in the MLT Listing Grid Tabs widget.
...
## 5.6.83
- **ENHANCEMENTS:** ReCaptcha added to the "Get Car Price" form
- **FIX:** Rental discount was not applied or displayed during Checkout in the Rental layout
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.96
- **UPD:** Motors Elementor Widgets plugin updated to version 1.6.9
- **UPD:** Motors WPBakery Widgets plugin updated to version 1.7.3
- **UPD:** WPBakery updated to version 8.7.2

## 5.6.82
- **FIX:** Minor bugfix

## 5.6.81
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.94
- **UPD:** RevSlider plugin updated to version 6.7.38

## 5.6.80
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.91
- **UPD:** WooCommerce templates updated to the latest version

## 5.6.79
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.88
- **UPD:** Updated the WPBakery plugin to version 8.6.1
- **UPD:** Updated the Slider Revolution plugin to version 6.7.37
- **UPD:** STM Motors Extends plugin updated to version 2.6.3

## 5.6.78
- **FIX:** Fixed duplication of the title box and breadcrumbs when creating new posts.
- **FIX:** Fixed an issue where Inventory would break if only one option was selected in Autogenerate listing title.
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.85

## 5.6.77
- **FIX:** Minor bugfix
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.84

## 5.6.76
- **IMPROVEMENT:** Added a new "Page Options" section with visual settings for Motors Listing Types plugin
- **IMPROVEMENT:** Added the ability to select values from the existing "Custom Fields" list in the "Autogenerate a listing title" setting
- **UPD:** Motors – Car Dealer, Classifieds & Listing theme updated to version 1.4.83
- **UPD:** Motors Listing Types plugin updated to version 1.4.4
- **UPD:** STM Motors Extends plugin updated to version 2.6.2
- **UPD:** STM Motors Importer plugin updated to version 5.4.1

## 5.6.75
- **FIX:** Fixed numerous visual issues related to colors and block sizes across layouts: Classified One, Classified Two, Classified Five, Boats, Auto Parts, Car Repair Service, Rental Two, and Dealership Two
- **FIX:** Fixed the empty dropdown display in filters on the Inventory page
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.82
- **UPD:** Motors Elementor Widgets to v1.6.8
- **UPD:** Motors Megamenu to v2.3.15.
- **UPD:** Motors Listing Types plugin is updated to v1.4.3.

## 5.6.74
- **FIX:** Fixed Offices post type not being displayed for Rent a Car demos.
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.81.
- **UPD:** STM Motors Extends plugin is updated to v2.6.1.
- **UPD:** Motors Listing Types plugin is updated to v1.4.2.

## 5.6.73
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.80
- **FIX:** Minor bug fixes.
- **FIX:** Fixed compatibility issue with the Subscriptio plugin preventing updates

## 5.6.72
- **FIX:** Minor bug fixes.
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.79
- **UPD:** STM Motors Extends plugin is updated to v2.6.0.
- **UPD:** Motors Listing Types plugin is updated to v1.4.1.
- **UPD:** Subscriptio plugin updated to 3.1.4.

## 5.6.71
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.78
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.7
- **FIX:** Fixed WhatsApp button not displaying in new listings
- **FIX:** Fixed Contact details in headers not being visible on Desktop view when disabled for Mobile

## 5.6.70
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.76
- **UPD:** WPBakery updated to 8.5.0
- **NEW FEATURE:** Added a centralized Listing Manager for streamlined inventory control.
- **FIX:** Fixed small and compressed dealer avatar sizes in profile settings and site header

## 5.6.69
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.75
- **UPD:** RevSlider upgraded to version 6.7.34
- **UPD:** STM Motors Extends plugin is updated to v2.5.9

## 5.6.68
- **FIX:** Resolved issue with password reset functionality not working.
- **UPD:** Motors - Events plugin updated to 1.4.8
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.73

## 5.6.67
- **FIX:** Minor bugfixes.
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.71

## 5.6.66
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.70
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.6
- **UPD:** Motors Listing Types plugin is updated to v1.4.0
- **ENHANCEMENTS:** Renamed “Filter by listing categories” to “Sort by custom fields”.
- **FIX:** Import/Export settings now work correctly.
- **FIX:** Fixed the Elementor widget “Rental office map” not displaying in Rental 1.
...
## 5.6.65
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.69
- **UPD:** Slider Revolution updated to 6.7.32
- **UPD:** WPBakery updated to 8.4.1
- **FIX:** Fixed an issue where “Sale” and “Regular” labels swapped places in the Boat Dealership demo.

## 5.6.64
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.67
- **UPD:** STM Motors Extends plugin is updated to v2.5.8
- **FIX:** Minor bugfixes.

## 5.6.63
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.66
- **UPD:** STM Motors Extends plugin is updated to v2.5.7
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.5
- **FIX:** Resolved an issue where enabling a previously disabled listing exceeded the specified slot limit in the plan.
- **FIX:** Fixed an issue where the "Add Listing" form was incorrectly displayed in Dealer demos.
- **FIX:** Resolved an issue where the "Become a Dealer" button was missing from the user profile.

## 5.6.62
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.65
- **UPD:** STM Motors Extends plugin is updated to v2.5.6
- **FIX:**  Resolved an issue where the Show More button didn't work on the dealer page.
- **FIX:**  Minor bug fixes.

## 5.6.61
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.64
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.4
- **UPD:** STM Motors Extends plugin is updated to v2.5.5
- **ENHANCEMENTS:** Merged Seller Note and Description fields for easier editing of single listing content.
- **FIX:** Fixed an issue when filter categories couldn't be selected with Elementor Pro's custom footer.
- **FIX:** Fixed a bug where descriptions and features didn’t sync correctly with Automanager.

## 5.6.60
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.63
- **UPD:** STM Motors Extends plugin is updated to v2.5.4
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.3
- **FIX:** Fixed an issue when filtering by features was working incorrectly.
- **FIX:** Resolved an issue with Listings Grid Tabs not showing more than 8 listings in Elementor layouts.
- **FIX:** Corrected the bottom main menu color not changing on a home page in Rental 2.

## 5.6.59
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.62
- **UPD:** STM Motors Extends plugin is updated to v2.5.3
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.2
- **UPD:** Motors WPBakery Widgets plugin is updated to v1.7.2
- **FIX:** Fixed the Login & Registration buttons in the top bar redirecting incorrectly in Classified 3.
- **FIX:** Fixed an issue with the title length limit in widgets displaying the listings grid.
- **FIX:** Resolved an issue where Listing titles were not automatically generated in the Listing Grid and Listing Carousel widgets.
- **FIX:** Footer no longer breaks when adding a large number of testimonials on a page in WP Bakery layouts.
- **FIX:** Addressed "Show More" and "Sort By" buttons in the Dealers List widget working incorrectly.
- **FIX:** Fixed Advanced User Data and WhatsApp button not displaying in new listings. 
- **FIX:** Resolved an issue with Offices missing in the Rent a Car layout.

## 5.6.58
- **UPD:** STM Motors Extends plugin is updated to v2.5.2
- **UPD:** Motors Listing Types plugin is updated to v1.3.9
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.57
...
- **FIX:** Corrected the custom icon option not appearing in Theme Options.
- **FIX:** Fixed a missing option to add custom icons for Listing types.
- **FIX:** Resolved an issue when Page Options were not shown for Listings, Posts, Pages.

## 5.6.57
- **FIX:** Minor bugfixes.

## 5.6.56
- **UPD:** Slider Revolution updated to 6.7.28.
- **UPD:** WPBakery updated to 8.2.
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.56
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.1
- **UPD:** Motors WPBakery Widgets plugin is updated to v1.7.1
- **UPD:** Motors – Equipment plugin is updated to v1.2.4
- **FIX:** Fixed an issue where Google Chrome browser saved the phone number instead of the username in their autofill password storage during user registration.
- **FIX:** Fixed the issue with the broken layout in Listing Manager.
- **FIX:** Small bug fixes.

## 5.6.55
- **FIX:** Fixed an issue when Features and Offices fields with dropdown list didn't open in Rentals layouts.
- **FIX:** Corrected the Offices settings missing in Rent a Car Elementor layout.
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.55
- **UPD:** STM Motors Extends plugin is updated to v2.5.1

## 5.6.54
- **FIX:** Fixed an issue with sorting filters on the Inventory page not working when the Filter Bar Position was set to horizontal.
- **FIX:** Small bug fixes
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.54
- **UPD:** Motors Elementor Widgets plugin is updated to v1.6.0
- **UPD:** Motors WPBakery Widgets plugin is updated to v1.7.0
- **UPD:** Motors Car Rental plugin is updated to v1.9.0
...
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.53
- **UPD:** STM Motors Extends plugin is updated to v2.5.0
- **UPD:** Motors Elementor Widgets plugin is updated to v1.5.9
...
- **UPD:** STM Motors Extends plugin is updated to v2.4.9
- **UPD:** Motors WPBakery Widgets plugin is updated to v1.6.9
...
- **ENHANCEMENTS:** Added image previews in the plugin settings for easier visualization.
- **FIX:** Resolved an issue where slider fields were missing in the inventory filter in WPBakery layouts.
- **FIX:** Fixed a problem where images were not displayed after demo import in WPBakery Classified.
- **FIX:** Resolved an issue with numeric values not displaying in numeric fields in STM Classic Filter in WPBakery demos.
...
- **ENHANCEMENTS:** Introduced a Preview Page button in the Add Listing Form settings for better usability.
- **FIX:** Fixed issues on the My Favorites page where the Grid List view toggle did not work, and images were not displayed correctly.
...
- **FIX:** Addressed a problem with new listings not displaying on Listings Tabs in Elementor and WPBakery widgets.
...
- **ENHANCEMENTS:** Added a message that shows up instead of the Rental selection form when the WooCommerce plugin is inactive.
- **UPD:** Motors Elementor Widgets plugin is updated to v1.5.4
- **UPD:** Motors WPBakery Widgets plugin is updated to v1.6.7
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.43
- **UPD:** Motors Car Rental plugin is updated to v1.8.9
- **UPD:** STM Motors Extends plugin is updated to v2.4.7
...
- **UPD:** Motors – Car Dealer, Classifieds & Listing is updated to v1.4.42
- **FIX:** Resolved an issue where the minimum price of Special products on the main page depended on the booking date in the Rental Two layout.
- **FIX:** Fixed an issue when adding subcategory was not working in Listing Manager.
- **FIX:** Fixed the "Make an Offer" price form not functioning.
- **FIX:** Corrected grid alignment issues for blog posts in Grid View.
- **FIX:** Resolved widgets not loading on Inventory page after importing in Classified 4 layout.
- **FIX:** Fixed an issue with Dealer Search not working correctly when a custom field included a hyphen.
