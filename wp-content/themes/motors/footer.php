...
if ( ! is_404() && ! is_page_template( 'coming-soon.php' ) ) { ?>
	<footer id="footer">
		...
		if ( ! is_plugin_active( 'elementor/elementor.php' ) && is_singular( apply_filters( 'stm_get_multilisting_types', apply_filters( 'stm_listings_post_type', 'listings' ) ) ) && apply_filters( 'motors_vl_get_nuxy_mod', '', 'listing_template_type' ) !== 'motors' ) {
