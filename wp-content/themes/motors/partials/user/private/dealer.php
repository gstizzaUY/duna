				...
				<div class="stm-user-private-sidebar">
					...
					<div class="clearfix stm-user-top">
						...
						<div class="stm-user-profile-information">
							<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'settings' ), apply_filters( 'stm_get_author_link', '' ) ) ); ?>"
					...
					<?php if ( apply_filters( 'stm_pricing_enabled', false ) ) : ?>
						...
						<div class="stm-user-current-plan-info heading-font">
							<?php if ( ! empty( $stm_user_active_subscriptions ) ) : ?>
								...
								<script type="text/javascript">
									jQuery(document).ready(function () {
										var $ = jQuery;
										$(".stm-start-countdown")
											.countdown("<?php echo esc_html( $stm_user_active_subscriptions['expires'] ); ?>", function (event) {
												$(this).text(
							...
							<?php elseif ( $date_expires ) : ?>
								<div class="sub-title"><?php esc_html_e( 'Subscription renewal', 'motors' ); ?></div>
								<div class="days-left"><?php echo esc_html( date( $wp_date_format, $date_expires ) ); ?></div>
							<?php endif; ?>
					...
					<?php else : ?>
						<div class="show-my-profile">
							<a href="<?php echo esc_url( apply_filters( 'stm_get_author_link', 'myself-view' ) ); ?>" target="_blank"><i
