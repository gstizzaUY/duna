...
function stm_initialize_post_types() {
	...
	stm_setup_post_type_meta_boxes( $choosen_template );
}

add_action( 'init', 'stm_initialize_post_types', 20 );

function stm_setup_post_type_meta_boxes( $choosen_template ) {
	$post_types = array(
		'listings',
	);
	...
	STM_PostType::addMetaBox(
		...
		array_merge( array( 'page', 'post', 'product', 'stm_events', 'stm_review' ), $post_types ),
		'',
		'',
		'',
		array(
	...
	if (
		'listing' === $choosen_template
		|| 'listing_two' === $choosen_template
		|| 'listing_two_elementor' === $choosen_template
		|| 'listing_three' === $choosen_template
		|| 'listing_three_elementor' === $choosen_template
		|| 'listing_four' === $choosen_template
		|| 'listing_four_elementor' === $choosen_template
		|| 'listing_five' === $choosen_template
		|| 'listing_five_elementor' === $choosen_template
		|| 'listing_one_elementor' === $choosen_template
	) {
