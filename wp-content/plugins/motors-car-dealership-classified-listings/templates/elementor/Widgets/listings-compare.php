		...
		<?php if ( ! empty( $compared_items ) || count( $compared_items ) !== 0 ) : ?>
			...
			if ( $compares->have_posts() ) :
				...
				<div class="row row-4 car-listing-row stm-car-compare-row">
					<div class="mvl-compare-meta-table col-md-3 col-sm-3 col-xs-12">
					...
					while ( $compares->have_posts() ) :
						...
						<div class="mvl-compare-item compare-column-stm-<?php echo esc_attr( get_the_ID() ); ?>">
							...
							<?php if ( ! empty( $filter_options ) && wp_is_mobile() ) : ?>
								<div class="compare-values">
									...
									<table class="mobile-compare-table">
			...
			<?php if ( $compares->have_posts() ) : ?>
				<div class="row row-4 stm-compare-row compare-desctop-table">
			...
			<div class="row row-4 car-listing-row stm-car-compare-row stm-no-cars">
				<div class="col-3 mvl-compare-title">
					<h2 class="compare-title">
						<?php echo esc_html( $widget_title ); ?>
					</h2>
					<div class="colored-separator text-left">
			...
			<div class="row row-4 stm-compare-row hidden-xs compare-desctop-table">
