...
class ButterBean_Setting {
	...
	public function save() {
		...
		} elseif ( $new_value !== $old_value ) { // If the new value doesn't match the old value, set it.
			update_post_meta( $this->manager->post_id, $this->name, $new_value );
		}

		do_action( 'stm_create_butterbean_meta', $this->manager->post_id, $this->name, $new_value );
	}
