...
function stm_listings_metaboxes() {
	...
	STM_Vehicle_PostType::addMetaBox(
		'single_car_options',
		__( 'Single car page options', 'stm_vehicles_listing' ),
		array( 'listings' ),
		'',
		'',
		'',
		array(
			'fields' => array(
				...
				'stm_lng_car_admin'         => array(
					'label' => __( 'Longitude', 'stm_vehicles_listing' ),
					'type'  => 'hidden',
				),
				'divider_mpg'               => array(
	...
	STM_Vehicle_PostType::addMetaBox(
		'special_offers',
		__( 'Special offer settings', 'stm-post-type' ),
		array( 'listings' ),
		'',
		'',
		'',
	...
	if ( ! empty( $options ) ) {
		...
		if ( class_exists( 'STM_Vehicle_PostType' ) ) {
			STM_Vehicle_PostType::addMetaBox(
				'listing_filter',
				__( 'Car Options', 'stm_vehicles_listing' ),
				array( 'listings' ),
				'',
				'',
				'',
