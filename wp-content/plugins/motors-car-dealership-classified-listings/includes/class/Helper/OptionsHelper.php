...
class OptionsHelper {
	...
	public static function get_listing_options_from_request() {
		...
		if ( class_exists( \MotorsVehiclesListing\Features\FriendlyUrl::class ) && ! empty( \MotorsVehiclesListing\Features\FriendlyUrl::$for_filter ) ) {
			$friendly_url_params = \MotorsVehiclesListing\Features\FriendlyUrl::$for_filter;
		}
