...
class MVL_Const {
	public const MVL_PLUGIN_OPT_NAME       = 'motors_vehicles_listing_plugin_settings';
	public const ADD_CAR_FORM_OPT_NAME     = 'mvl_add_car_form_settings';
	public const FILTER_OPT_NAME           = 'mvl_search_and_filter_settings';
