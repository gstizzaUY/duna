(function ($) {
    ...
    $(document).ready(function () {
         ...
         */
        let body = 'body';
        let feedback_modal = '#mvl-feedback-modal'

        $(body).on('click', '.mvl-feedback-button', function (e) {
            e.preventDefault();
        ...
        $(body).on('click', function ( e ) {
            if ( e.target.id === 'mvl-feedback-modal' ) {
                $(feedback_modal).fadeOut(200);
            }
        });
        ...
        $(body).on('click', '.feedback-submit', function (e) {
            ...
            if ( rating < 4 ) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        'item': 'motors-car-dealership-classified-listings',
                        'type': 'plugin',
                        rating,
                        review
                    },
            ...
            $.ajax({
                url: ajaxurl,
                type: 'GET',
                data: 'action=mvl_ajax_add_feedback',
                success: function (data) {
                    $('.mvl-feedback-button').remove()
                }
            });
        });
