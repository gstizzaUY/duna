...
(function ($) {
  ...
  function initMobileSidebar() {
    ...
    var $head = $(
      '<div class="wsf-mobile-sidebar-head"><span>Categor├¡as / Filtros</span>' +
  ...
  function initCategoryWidget() {
    ...
    $widget.find('li.cat-parent').each(function () {
      ...
      var $toggle = $('<button type="button" class="wsf-cat-toggle" aria-expanded="false" aria-label="Subcategor├¡as"><span>&#9656;</span></button>');
      $li.prepend($toggle);
